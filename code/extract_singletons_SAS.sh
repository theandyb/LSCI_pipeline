...
#SBATCH --requeue
#SBATCH -p main
#SBATCH -e output/slurm/singleton_SAS-%A_%a.err
#SBATCH -o output/slurm/singleton_SAS-%A_%a.out
...
bcftools view -i "(AC_SAS_unrel == 1 | (AC_Hom_SAS_unrel == 2 & AC_Het_SAS_unrel ==0)) & AC_EUR_unrel == 0 & AC_AMR_unrel == 0 & AC_EAS_unrel == 0 & AC_AFR_unrel == 0" |\
