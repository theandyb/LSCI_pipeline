...
#SBATCH --job-name=two_pos_resid
#SBATCH --requeue
#SBATCH -p main
#SBATCH --array=0-53
#SBATCH -e output/slurm/tpresid-%A_%a.err
#SBATCH -o output/slurm/tpresid-%A_%a.out
...
python code/two_position_resid.py -p ${VAR1} -t ${VAR2}
