...
#SBATCH --job-name=three_pos_arr
#SBATCH --requeue
#SBATCH -p main
#SBATCH --array=0-53
#SBATCH -e output/slurm/tpa-%A_%a.err
#SBATCH -o output/slurm/tpa-%A_%a.out
...
echo "Running three position models for subtype ${VAR2} in population ${VAR1}"

python code/three_pos_stat.py -p ${VAR1} -t ${VAR2} -o output
